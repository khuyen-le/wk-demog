var customSurveyMultiChoiceImage = (function (jspsych) {
  'use strict';
      ...
      parameters: {
          ...
          questions: {
              ...
              nested: {
                ...
                /** Array of illustrations for each option. */
                options_illustration: {
                    type: jspsych.ParameterType.IMAGE,
                    pretty_name: "Illustrations",
                    array: true,
                    default: null,
                },
   ...
   */
  class SurveyMultiChoiceImagePlugin {
      constructor(jsPsych) {
      ...
      trial(display_element, trial) {
          ...
          for (var i = 0; i < trial.questions.length; i++) {
              ...
              for (var j = 0; j < question.options.length; j++) {
                  ...
                  var location = (j == 0) ? "jspsych-survey-multi-choice-option-left" : "jspsych-survey-multi-choice-option-right"; 
                  var required_attr = question.required ? "required" : "";
                  // add radio button container
                  html += '<div id="' + option_id_name + '" class="jspsych-survey-multi-choice-option ' + location + '">';
                  ...
                  html +=
                      '<input type="radio" name="' +
                          ...
                          required_attr +
                          "></input>";
                    html += '<img src="' + question.options[j] + '" style="height: 100px">';
                    html += '<br>';
                    if (question.options_illustration !== null) {
                        html += '<img src="' + question.options_illustration[j] + '" style="width: 500px">';
                    }
  ...
  SurveyMultiChoiceImagePlugin.info = info;

  return SurveyMultiChoiceImagePlugin;
