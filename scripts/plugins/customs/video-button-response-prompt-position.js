var customVideoButtonResponsePromptPos = (function (jspsych) {
  'use strict';
  ...
  const info = {
      ...
      parameters: {
        ...
        prompt_before_stim: {
            type: jspsych.ParameterType.BOOL,
            pretty_name: "Prompt before stimulus",
            default: false,
            },
   ...
   */
  class VideoButtonResponsePromptPositionPlugin {
      constructor(jsPsych) {
      ...
      `);
          ...
          // setup stimulus
          var video_html = "<div>";
        // add prompt before stimulus if there is one
        if (trial.prompt_before_stim) {
          ...
          // add prompt before choices if there is one
          ...
          video_html += "</div>";
          // add prompt after choices if there is one
  ...
  VideoButtonResponsePromptPositionPlugin.info = info;

  return VideoButtonResponsePromptPositionPlugin;
