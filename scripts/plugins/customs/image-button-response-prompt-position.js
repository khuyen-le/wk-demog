...
var customImageButtonResponsePromptPos = (function (jspsych) {
    'use strict';
    
    const info = {
        name: "image-button-response-prompt-pos",
        parameters: {
    ...
    */
    class ImageButtonResponsePromptPositionPlugin {
        constructor(jsPsych) {
    ...
    ImageButtonResponsePromptPositionPlugin.info = info;
    
    return ImageButtonResponsePromptPositionPlugin;
